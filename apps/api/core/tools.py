    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "catalogue, spec sheet, company profile/info, etc. Match on what the "
                "contact actually wants, not the exact wording of the file's name or "
                "description — e.g. 'what do you guys do', 'tell me about your company', "
                "or 'who are you' should all be recognized as asking for a company-info "
                "file if one is listed, even though none of those phrases appear in its "
                "name or description. The files you can send are listed in your "
