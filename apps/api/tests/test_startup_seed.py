...
from apps.api.db.startup_seed import DEFAULT_OWNER_ID, ensure_env_seed_data
...
async def test_startup_seed_creates_default_org_owner_and_env_numbers(
    ...
    monkeypatch.setattr("apps.api.db.startup_seed.settings.twilio_phone_number", "+1 (980) 372-2373")
